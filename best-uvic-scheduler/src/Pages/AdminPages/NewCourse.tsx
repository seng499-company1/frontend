...
export function NewCoursePage() {
  ...
  const [absenceReason, onAbsenceReason] = useState("");
  ...
  return (
    <FormDiv>
      ...
      <SelectableTableCheckboxDiv>
      <SubHeader> minimum number of times a year this course should be offered: </SubHeader>
      <MaxCoursesInput
        type="number"
        value={maxCourses}
        onChange={(event) => {
      ...
      <SelectableTableCheckboxDiv>
      <SubHeader> What year should this course be taken (What year on the worksheet): </SubHeader>
      <MaxCoursesInput
        type="number"
        value={courseYear}
        onChange={(event) => {
      ...
      <AbsenceTextarea
        value={absenceReason}
        onChange={(event) => {
          onAbsenceReason(event.target.value);
        }}
      />
      <SubHeader> A description of qualifications needed to teach this course: </SubHeader>
      <AbsenceTextarea
